...
const App = () => {
  ...
  const renderNotConnectedContainer = () => (
    <div>
      <img
        src="https://media.tenor.com/OT8xEFxko88AAAAC/solana-stakefish.gif"
        alt="emoji"
      />
    ...
    <div className="App">
      ...
      <div className="container">
        <header className="header-container">
          <p className="header">📚 Loja de capas 🪙</p>
          <p className="sub-text">
            A única loja de capas de livros que aceita CriptoNitas
          </p>
